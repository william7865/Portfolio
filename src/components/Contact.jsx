        ...
        <section id = "contact" className="contact-section">
            <div className="container">
                <div className="contact-text">
                    ...
                    <p>
                        Je suis actuellement à la recherche d'une alternance dans le domaine du développement web ou de la conception de dispositifs interactifs. Disponible à partir de septembre 2024, je recherche un rythme d'alternance de 2 semaines en entreprise et 1 semaine de cours. N'hésitez pas à me contacter pour échanger sur la manière dont je pourrais apporter de la valeur à votre entreprise.
                    </p>
                </div>
